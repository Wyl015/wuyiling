...
public class G2TokenTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(G2TokenTest.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String nonce =  "dfgerer345gdYewj3fsasw2E";
        ...
        String uid = "hzyw13642296655500897".substring(4);
...
//        nvps.add(new BasicNameValuePair("channelName", "123456"));
    ...
    private static Long timeGapTest() {
