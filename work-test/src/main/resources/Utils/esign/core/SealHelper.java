...
public class SealHelper {
	...
	public static String doAddTemplateSeal(ServiceClient serviceClient, String accountId,
                                           PersonTemplateType personTemplateType, SealColor sealColor) throws EsignException {
	...
	public static String doCreatePersonalTemplateSeal(ServiceClient serviceClient,
                                                      PersonTemplateType personTemplateType, String text, SealColor sealColor) throws EsignException {
	...
	public static String doCreateOfficialTemplateSeal(ServiceClient serviceClient,
                                                      ...
                                                      SealColor sealColor) throws EsignException {
	 ...
	 * @throws EsignException
	 */
	public static String doGetImageBase64StrFromUrl(String imgURL) throws EsignException {
		byte[] data = null;
		...
		if (null == imgageBase64String || imgageBase64String.length() == 0) {
			throw new EsignException("图片Base64字符串为空,请检查造成原因.");
		}
	 ...
	 * @throws EsignException
	 */
	public static String doGetImageStrFromPath(String imgPath) throws EsignException {
		InputStream in = null;
		byte[] data = null;
		// 读取图片字节数组
		try {
	...
	public static void doSaveBase64AsImageFile(String imgBase64String, String dir, String fileName)
		...
		if (imgBase64String == null) {
			throw new EsignException("将Base64字符串保存为本地图片文件时发生异常：图片Base64字符串不能为空");
		}
