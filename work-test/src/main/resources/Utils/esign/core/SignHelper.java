...
public class SignHelper {
    ...
    public static void doSelfLocalSignPDF(ServiceClient serviceClient, SignPDFFileBean file, PosBean posBean,
                                          int sealId, SignType signType) throws EsignException {
     ...
     * @throws EsignException
     */
    public static void doSelfLocalSignPDF(ServiceClient serviceClient,
                                          SignPDFFileBean file,
                                          PosBean posBean,
                                          String sealData,
                                          SignType signType) throws EsignException {
     ...
     * @throws EsignException
     */
    public static FileDigestSignResult doSelfLocalSignPDF(ServiceClient serviceClient,
     ...
     * @throws EsignException
     */
    public static void doUserLocalSignPDF(ServiceClient serviceClient,
                                          String accountId,
                                          String sealData,
                                          SignPDFFileBean file,
                                          PosBean posBean,
    ...
    public static FileDigestSignResult doUserLocalSignPDF(ServiceClient serviceClient, String accountId, String sealData,
                                                          SignPDFStreamBean stream, PosBean posBean, SignType signType) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
    ...
    public static void doUserLocalSafeSignPDF(ServiceClient serviceClient, String accountId, String sealData,
                                              SignPDFFileBean file, PosBean posBean, SignType signType, String code) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
     ...
     */
    public static void doUserLocalSafeSignPDF(ServiceClient serviceClient, String accountId, String sealData,
                                              SignPDFStreamBean stream, PosBean posBean, SignType signType, String code) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
    ...
    public static void doUserLocalSafeSignPDF3rd(ServiceClient serviceClient, String accountId, String sealData,
                                                 SignPDFFileBean file, PosBean posBean, SignType signType, String mobile, String code) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
    ...
    public static void doUserLocalSafeMultiSignPDF(ServiceClient serviceClient, String accountId,
                                                   List<SignParamBean> signParams, String sealData, String code) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
     ...
     */
    public static void doUserLocalSafeMultiSignPDF(ServiceClient serviceClient, String accountId,
                                                   List<SignParamBean> signParams, String sealData, String mobile, String code) throws EsignException {
        UserSignService userSignService = serviceClient.userSignService();
