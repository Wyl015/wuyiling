...
public class FileHelper {
	 ...
	 * @throws IOException
	 */
	public static byte[] doGetFileBytes(String filePath) throws EsignException {
	 ...
	 * @throws EsignException
	 */
	public static void doSaveFileByStream(byte[] bytes, String outSignedPdfPath) throws EsignException {
