...
public class PDFTemplateHelper {
     ...
     */
    public static void doCreateFileFromTemplate(ServiceClient serviceClient,
                                                String srcPdfPath,
                                                String outPdfPath,
                                                String pdfEditPWD,
                                                Boolean isFlat,
        ...
        if (StringUtils.isNotBlank(pdfEditPWD)) {
            // 待填充PDF模板文件编辑密码
    ...
    public static void doCreateFileFromTemplateA(ServiceClient serviceClient, byte[] pdfBytes, String outPdfPath,
                                                 String pdfEditPWD, Boolean isFlat, Map<String, Object> txtFields) throws EsignException {
        // 设置模板生成接口中输入输出文件路径封装对象SignPDFFileBean属性
