package com.wuyiling.worktest.Utils.download;

import com.yuuwei.faceview.util.ConverterUtil;
...
public class ExcelExportUtils {
    ...
    public static <T> void exportCsv(HttpServletResponse response, String fileName, String title, T t, Function<T, String> function) {
        ...
        try {
            ...
            logger.error("export csv error, | t = " + t.toString(), e);
        }
    }
