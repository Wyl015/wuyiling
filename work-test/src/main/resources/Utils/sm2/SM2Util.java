package com.wuyiling.worktest.Utils.sm2;
...
public class SM2Util {
    ...
    public void generateKeyPair() {
        try {
            ...
            // 拿到密钥
            SM2KeyPair.publicKey = new String(Hex.encode(publicKey.getQ().getEncoded(false)));
            SM2KeyPair.privateKey = privateKey.getD().toString(16);
        } catch (Exception e) {
